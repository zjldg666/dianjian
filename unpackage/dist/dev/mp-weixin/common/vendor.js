...
function initRuntimeSocketService() {
  const hosts = "172.16.9.174,127.0.0.1,192.168.160.1";
  const port = "8090";
  const id = "mp-weixin_X89dwV";
